...
Anonymous function:
  ...
  return findmedian=arr.length%2===1 ? arr[medianindex]:(arr[medianindex-1]+arr[medianindex])/2;
}
  console.log(findmedian([1,2,3,4,5,7],[3,5,6,7,8]));

    IIFE:(function findmedian(arr1,arr2){
      let arr=[...arr1,...arr2]
      arr.sort((a,b)=>a-b)
      let  medianindex=Math.floor(arr.length/2)
      return findmedian=arr.length%2===1 ? arr[medianindex]:(arr[medianindex-1]+arr[medianindex])/2;
    })([1,2,3,4,5,7],[3,5,6,7,8]);
